...
def app():
    # Main page content
    st.set_page_config(page_title = 'AIC Dashboard -- Uganda SCORE Survey', page_icon='🇺🇬',layout='wide')

    title = 'Comparison of Scores of Questions Within One Section Within AIC'
    ...
    if not filtered_data.empty:
        ...
        if plot_selected == 'Bar Plot':
            ...
            chart = alt.Chart(filtered_data).mark_bar().encode(
                ...
                width=600,
                height=600,
                title=f'AIC -- Bar Plot of Scores by Question within {module_selected1}: {part_selected}'
            )
            ...
            final_chart1 = alt.layer(pie, text1).properties(
                width=600,
                height=400,
                title=f'AIC -- Pie Plot of Scores by Question within {module_selected1}: {part_selected}'
            ).configure_axis(
                labelFontSize=12,
                titleFontSize=14
            ).interactive()
            ...
            fig = px.line_polar(filtered_data, r='Score', theta='Question1', line_close=True,
                                ...
                                title=f'AIC -- Radar Plot of Scores by Question within {module_selected1}: {part_selected}',
                                hover_data={
                                    'Question': True,
                                    'Score': True,  
                                    'Level': True,  
            ...
            st.markdown(f"#### Comparison of Score by Questions in AIC are shown below:")
